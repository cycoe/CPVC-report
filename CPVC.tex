...
\setCJKmainfont[Path = src/fonts/, BoldFont=simhei.ttf]{simsun.ttc}

%\newcommand{\song}{\CJKfamily{simsun}}  % 宋体
\newCJKfontfamily{\hei}{\CJKfamily{SimHei}}   % 黑体
...
\setlength{\abovecaptionskip}{-0pt}		%图表标题与图表间距
% \setlength{\bibsep}{5pt}				%参考文献间距
\renewcommand\arraystretch{1.2}			%设置表格内部高度
...
% \CTEXsetup[beforeskip={0pt}, afterskip={0pt}]{subsubsection}
