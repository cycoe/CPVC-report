...
\documentclass[a4paper, oneside, onecolumn, titlepage, 12pt]{ctexrep}    % transmag 实现双列排版，摘要跨列
...
\tikzstyle{pro} = [rectangle, minimum width = 3cm, minimum height = 1cm, text centered, draw = black]
\tikzstyle{io} = [rectangle, rounded corners, minimum width = 3cm, minimum height = 0.7cm, text centered, draw = black]
