...
根据 $E_1 \sim E_4$ 四组配方的 损耗因子-时间 数据制得图 \ref{fig1Tg}，取损耗因子的峰值温度作为试样的玻璃化转变温度。根据实验结果，$E_3$ 和 $E_4$ 组具有最高的玻璃化温度，分别为 155.17\cd 和 154.03\cd，比 $E_1$ 和 $E_2$ 组的 146.09\cd 和 147.78\cd 平均高 7\cd 左右。本实验结果与静态热稳定性测试的结果一致，认为 AC-629 与 PEW-0380 对 CPVC 热性能的影响较小。
